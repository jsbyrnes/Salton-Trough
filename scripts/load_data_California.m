function [ dataStruct ] = load_data_California( TD_parameters )
    ...
    stations_to_remove       = { 'MLAC' 'SNCC' 'SCI2' 'PDM' };
    ssip_aswell              = 1;
    pert_ssip                = 0.0;
    ...
    for k=1:length(fnames)
        ...
        if ssip_aswell
            ...
            sta2   = {traces.station};
            lats2  = [traces.latitude];
            lons2  = [traces.longitude];
            tS2    = [traces.tStar];
