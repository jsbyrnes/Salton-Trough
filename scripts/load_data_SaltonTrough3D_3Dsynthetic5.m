function [ dataStruct ] = load_data_SaltonTrough3D_3Dsynthetic5( TD_parameters )
...
%         end
    ...
    Qmodel(xVec>=0   & xVec<=50, :, zVec>=60 & zVec<=90) = 3.5/1000;
    Qmodel(xVec>=-70 & xVec<=-20, :, zVec>=60 & zVec<=90) = 7.5/1000;
