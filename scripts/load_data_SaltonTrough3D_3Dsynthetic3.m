function [ dataStruct ] = load_data_SaltonTrough3D_3Dsynthetic3( TD_parameters )
...
%         end
    ...
    Qmodel = (1/180)*ones(length(xVec), length(yVec), length(zVec));
    
    Qmodel(xVec<0, :, zVec< 80)                       = 1/2000;
    Qmodel(xVec>50, :, zVec<80)                       = 1/2000;
    Qmodel(xVec>=0 & xVec<=50, :, zVec>=60 & zVec<=90) = 55/1000;
